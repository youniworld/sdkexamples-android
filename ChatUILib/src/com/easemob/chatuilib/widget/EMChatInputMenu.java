...
import com.easemob.chatuilib.widget.EMChatPrimaryMenu.ChatPrimaryMenuListener;
import com.easemob.chatuilib.widget.EMEmojicon.EmojiconListener;

public class EMChatInputMenu extends LinearLayout{
    protected EMChatPrimaryMenu chatPrimaryMenu;
    protected EMChatExtendMenu chatExtendMenu;
    protected FrameLayout chatExtendMenuContainer;
    protected EMEmojicon emojicon;
    private Context context;
    
    private Handler handler = new Handler();
    private ChatInputMenuListener listener;

    public EMChatInputMenu(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs);
    }

    public EMChatInputMenu(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        LayoutInflater.from(context).inflate(R.layout.em_widget_chat_input_menu, this);
        
        //主按钮菜单栏
        chatPrimaryMenu = (EMChatPrimaryMenu) findViewById(R.id.primary_menu);
        
        // 扩展按钮栏
        chatExtendMenu = (EMChatExtendMenu) findViewById(R.id.extend_menu);
