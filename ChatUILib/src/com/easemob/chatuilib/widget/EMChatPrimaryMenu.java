...
import com.easemob.chatuilib.widget.adapter.VoicePlayClickListener;


public class EMChatPrimaryMenu extends RelativeLayout implements OnClickListener {
    ...
    public EMChatPrimaryMenu(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EMChatPrimaryMenu(Context context) {
        super(context);
        init(context, null);
    }
