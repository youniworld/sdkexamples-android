...
import com.easemob.chatuilib.widget.adapter.ExpressionAdapter;
import com.easemob.chatuilib.widget.adapter.ExpressionPagerAdapter;
...
public class EMEmojicon extends LinearLayout{
	...
	private View getGridChildView(int i) {
		View view = View.inflate(context, R.layout.em_expression_gridview, null);
