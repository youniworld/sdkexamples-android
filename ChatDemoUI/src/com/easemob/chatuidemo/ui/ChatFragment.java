...
public class ChatFragment extends Fragment implements EMEventListener {
    ...
    protected int[] itemdrawables = { R.drawable.em_chat_takepic_selector, R.drawable.em_chat_image_selector,
            R.drawable.em_chat_location_selector, R.drawable.em_chat_video_selector, R.drawable.em_chat_file_selector,
