...
public class EMChatRowVoice extends EMChatRowBase {
	
	private static final String TAG = "EMChatRowVoiceWidget";

	public EMChatRowVoice(Context context, EMMessage message, int position, ViewGroup parent, MessageAdapter adapter) {
