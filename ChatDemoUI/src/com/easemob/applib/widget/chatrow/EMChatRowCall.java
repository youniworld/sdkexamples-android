...
public class EMChatRowCall extends EMChatRowBase {

	public EMChatRowCall(Context context, EMMessage message, int position, ViewGroup parent, MessageAdapter adapter) {
