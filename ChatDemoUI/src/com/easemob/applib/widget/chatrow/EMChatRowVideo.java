...
public class EMChatRowVideo extends EMChatRowBase {
	private static final String TAG = "EMChatRowVideoWidget";
	final Timer timer = new Timer();

	public EMChatRowVideo(Context context, EMMessage message, int position, ViewGroup parent, MessageAdapter adapter) {
