...
public abstract class EMChatRowBase extends LinearLayout {
	
	protected Context context;
	protected LayoutInflater inflater;
	protected EMChatMessageList messaegListView;
	...
	public EMChatRowBase(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	@SuppressLint("NewApi")
    public EMChatRowBase(Context context, AttributeSet attrs, int defStyleAttr) {
