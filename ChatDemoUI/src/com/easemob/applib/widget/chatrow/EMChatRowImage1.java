...
public class EMChatRowImage1 extends EMChatRowFile{

    protected ImageView imageView;

    public EMChatRowImage1(Context context, EMMessage message, int position, BaseAdapter adapter) {
     ...
     // 接收方向的消息
        if (message.direct == EMMessage.Direct.RECEIVE) {
            if (message.status == EMMessage.Status.INPROGRESS) {
                ...
                showDownloadPregress((FileMessageBody)message.getBody());
            } else {
