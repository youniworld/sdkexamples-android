...
public class EMChatRowFile extends EMChatRowBase {
	private static final String TAG = "EMChatRowRecvFileWidget";
	private Timer timer = new Timer();

	public EMChatRowFile(Context context, EMMessage message, int position, ViewGroup parent, MessageAdapter adapter) {
