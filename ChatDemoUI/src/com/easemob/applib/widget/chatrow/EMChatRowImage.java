...
public class EMChatRowImage extends EMChatRowBase {
	private static final String TAG = "EMChatRowImageWidget";
	private Timer timer;

	public EMChatRowImage(Context context, EMMessage message, final int position, ViewGroup parent, MessageAdapter adapter) {
